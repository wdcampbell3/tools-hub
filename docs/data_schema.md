...
- **Blog Posts**: Located in `src/routes/(marketing)/blog/posts/`. These are markdown/Svelte files, not database entries. They are compiled at build time.
- **Search Index**: Generated at build time from these static files.
