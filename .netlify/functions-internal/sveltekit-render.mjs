	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/meetings/_server.ts.js'))
			},
			{
				id: "/api/models",
				pattern: /^\/api\/models\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/models/_server.ts.js'))
			},
			{
				id: "/api/test-auth",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/test-auth/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/test-cloudinary/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/test-firebase/_server.ts.js'))
			},
			{
				id: "/api/test-stripe",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/test-stripe/_server.ts.js'))
			},
			{
				id: "/api/theme/save",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/theme/save/_server.ts.js'))
			},
			{
				id: "/api/theme/state",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/theme/state/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/(marketing)/auth/callback/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/(marketing)/auth/session/_server.ts.js'))
			},
			{
