<script lang="ts">
  ...
  function toggleTheme() {
    isLight = !isLight
    const newTheme = isLight ? themeLight : themeDark
...
<div class="fixed top-4 right-4 z-50">
  ...
  >
    ...
    <!-- moon icon (shows when light mode is Active i.e. checked -> Switch to Dark) -->
    <svg
      class="swap-on h-5 w-5 fill-current text-base-content"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    >
      <path
