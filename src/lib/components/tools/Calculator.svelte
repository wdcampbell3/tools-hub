  ...
  <div class="card bg-base-200 shadow-xl w-full max-w-md">
    <div class="card-body p-6">
      ...
      <div class="grid grid-cols-4 gap-2">
        ...
        <button class="btn btn-primary" onclick={() => setOperation("÷")}
          >÷</button
        >

        <!-- Row 2 -->
        <button class="btn btn-neutral" onclick={() => appendNumber("7")}
          >7</button
        >
        <button class="btn btn-neutral" onclick={() => appendNumber("8")}
          >8</button
        >
        <button class="btn btn-neutral" onclick={() => appendNumber("9")}
          >9</button
        >
        <button class="btn btn-primary" onclick={() => setOperation("×")}
          >×</button
        ...
        <!-- Row 3 -->
        <button class="btn btn-neutral" onclick={() => appendNumber("4")}
          >4</button
        >
        <button class="btn btn-neutral" onclick={() => appendNumber("5")}
          >5</button
        >
        <button class="btn btn-neutral" onclick={() => appendNumber("6")}
          >6</button
        >
        <button class="btn btn-primary" onclick={() => setOperation("-")}
          >-</button
        ...
        <!-- Row 4 -->
        <button class="btn btn-neutral" onclick={() => appendNumber("1")}
          >1</button
        >
        <button class="btn btn-neutral" onclick={() => appendNumber("2")}
          >2</button
        >
        <button class="btn btn-neutral" onclick={() => appendNumber("3")}
          >3</button
        >
        <button class="btn btn-primary" onclick={() => setOperation("+")}
          >+</button
        ...
        <!-- Row 5 -->
        <button
          class="btn btn-neutral col-span-2"
