...
<path d="M11 13H2" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round"/>`,
    },
    {
      ...
      description:
        "Tools you'll love working with, including SvelteKit, Tailwind, DaisyUI, Firestore, and Firebase.",
      linkText: "Docs",
      newPage: true,
  ...
  <div class="hero-content text-center py-12">
    <div class="max-w-xl">
      ...
      <div class="mt-6 md:mt-10 text-sm md:text-lg">
        ...
        >,
        <a href="https://firebase.google.com" class="link font-bold" target="_blank"
          >Firebase</a
        >,
