  ...
  const features = [
    {
      name: "Free to host",
      description:
        "Instructions included for deploying with Firebase. Free to start, and cost effective to scale.",
...
<path d="M17.5 9.74145C17.7095 9.53198 18.0491 9.53198 18.2586 9.74145C18.468 9.95092 18.468 10.2905 18.2586 10.5C18.0491 10.7095 17.7095 10.7095 17.5 10.5C17.2905 10.2905 17.2905 9.95092 17.5 9.74145Z" fill="#1C274C"/>`,
    },
    {
      ...
      link: "/login",
      description:
        "Sign up, sign out, forgot password, email verification, and oAuth. Powered by Firebase Auth.",
      svgContent: `<path
