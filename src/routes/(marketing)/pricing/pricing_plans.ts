...
export const pricingPlans = [
  ...
  },
  {
    ...
    description:
      "A downpayment for a project consulting work. You will be charged for the time spent on your project.",
    price: "$1500",
  ...
  },
  {
    ...
    description:
      "A one time payment for a project consulting work. You will be charged for the time spent on your project.",
    price: "$875",
    priceIntervalName: "one time payment",
